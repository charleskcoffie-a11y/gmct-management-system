                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-64 overflow-y-auto custom-scrollbar pr-2">
                            {activeEntries.slice(0, 5).map(entry => {
                                ...
                                const typeIcon = {
                                    ...
                                    "childrens-ministry": <svg className="w-7 h-7 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 12H9m4 5h4m-4 0v4m0-11V7a1 1 0 10-2 0v3m2 0H9" /></svg>,
