...
export function sanitizeEntryType(type: any): EntryType {
    ...
    const aliasMap: Record<string, EntryType> = {
        ...
        'womensharvest': 'womens-harvest',
        'womens-harvest': 'womens-harvest',
        'womensharvestoffering': 'womens-harvest',
        'mensharvest': 'mens-harvest',
        'mens-harvest': 'mens-harvest',
        'mensharvestoffering': 'mens-harvest',
        'youthharvest': 'youth-harvest',
        'youth-harvest': 'youth-harvest',
        'youthharvestoffering': 'youth-harvest',
        'youthharvestlevy': 'youth-harvest-levy',
        'youth-harvest-levy': 'youth-harvest-levy',
        'youthharvestlevyoffering': 'youth-harvest-levy',
        'organizationalanniversary': 'organizational-anniversary',
        'organizational-anniversary': 'organizational-anniversary',
        'organisationanniversary': 'organizational-anniversary',
        'organizationanniversary': 'organizational-anniversary',
        'pledges': 'pledge',
        'kofi-ama': 'day-born',
        'kofiandama': 'day-born',
    };
